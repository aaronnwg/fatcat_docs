...
Limit orders execute only when the price hits your target. See [Limit orders](../limit-orders.md).

### Before you swap

* You need a wallet. See [Setting Up Your Wallet](../../overview/getting-started/setting-up-your-wallet.md).
...
* [Market Buy & Market Sell](market-buy-and-market-sell.md)
